...
class TestBatch(CNN):
    def __init__(self, img_path, char_set, model_save_dir, model_save_name, total):
        # 模型路径
...
def main():
    test_image_dir = CAPTCHA_CONFIG["test_image_dir"]
    ...
    total = 100
    tb = TestBatch(test_image_dir, char_set, model_save_dir, model_save_name, total)
    tb.test_batch()
